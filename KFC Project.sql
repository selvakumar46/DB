...
--------------------------------------------------------------------------------------------------------------------------------
CREATE TABLE ORDER_ITEMS_1(ORDER_ID NUMBER,ITEM_ID NUMBER PRIMARY KEY,PRODUCT_ID NUMBER,CUSTOMER_ID NUMBER,QUANTITY NUMBER,TOTAL_PRICE NUMBER,STATUS VARCHAR2(100),EMP_ID NUMBER,
                            FOREIGN KEY (EMP_ID)REFERENCES EMPLOYEE_2(EMP_ID),FOREIGN KEY(ORDER_ID) REFERENCES CART(ORDER_ID), FOREIGN KEY (PRODUCT_ID)REFERENCES PRODUCTS_1(PRODUCT_ID),
